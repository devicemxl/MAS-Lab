...
/**
 * EnablesInterrelationship
 */
public class EnablesInterrelationship extends Interrelationship implements Serializable, Cloneable {

  /**
   * Constructor
   */
  public EnablesInterrelationship(String l, Agent a, Distribution delay) {
   ...
   * Blank Constructor
   */
  public EnablesInterrelationship() {
    super();
  }
   ...
   * In this context, enables will set the quality to zero if
   * it's not actif. <BR>
