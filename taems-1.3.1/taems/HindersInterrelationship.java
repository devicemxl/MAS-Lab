...
/**
 * HindersInterrelationship
 */
public class HindersInterrelationship extends Interrelationship implements Serializable, Cloneable {
 ...
 /**
   ...
   * As the NLE is hinders, we choose a power value from
